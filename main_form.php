...
<div id="wrap">
	<div id="header">
		<div class="logo" style="text-align:center;" onclick = "go_to_home()">
...
for ($i=$start; $i<$start+$scale && $i < $total_record; $i++){
	...
	?>
			<li class="DOCTYPE" style="padding: 20px;">
				...
				<span class="col2" ><img src= "./data/<?=$file_copied?>" style="width: 400px; float: left; margin-left: 10%;"></span>
			</li>	
	<?php
		$number--;
	}
	...
	?>
		...
		<ul id="page_num" style = "style=text-align : center;"> 
			
	<?php
	if ($total_page>=2 && $page >= 2)	{
		$new_page = $page-1;
		echo "<li><a href='main_form.php?page=$new_page'>◀ 이전</a> </li>";
	}		
	else 
		echo "<li>&nbsp;</li>";
